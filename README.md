...
React JS solves re-rendering of the DOM, react was made to solve facebooks problem of constantly updating changes. instead of updating the whole dom it will just repaint an area of the DOM which saves a lot of reload time

1. Describe component state.

components are basically pieces of the DOM, component state refers to the status or the state of it currently. states can change which can cause a re-render of specific parts of the dom

1. Describe props.

props are information passed from one js file to another. usually from a parent to a child component

1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?

sideEffects are things that happen as an effect when the DOM renders. there is a useEffect() hook where u can input a callback function that does something everytime the DOM renders
